...
select name,country,haversine(lat, long, blat, blong) as distance_km from (select a.name, a.country, a.lat, a.long, b.lat blat, b.long blong, vector_distance(b.coord,a.coord,euclidean) as distance from cities a, cities b where b.name='Friedrichshafen' order by distance limit 20);
